...
import { CardItem, Icon, Button, Text, Toast } from "native-base"
...
class CardDetail extends React.Component {
  ...
  componentDidMount = async () => {
    ...
    this.setState({ id, weight, newWeight: weight }, () =>
        ...
        <CardItem>
          ...
          >
            <View flexDirection="row">
              ...
              />
              <Text style={{ fontSize: 20, lineHeight: 40 }}>{"Cân Nặng"}</Text>
            </View>
            ...
            <Button full info onPress={this.showDialog}>
              <Text>{"Cập Nhật"}</Text>
            </Button>
            ...
            <Dialog.Container visible={visible}>
              ...
              <Slider
                ...
                onValueChange={value =>
                  this.setState({ newWeight: Math.round(value) })
                }
              />
              <Text style={{ textAlign: "center" }}>
                {Math.round(newWeight)}/kg
              </Text>
